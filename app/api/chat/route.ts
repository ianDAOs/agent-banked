...
export async function POST(req: Request) {
  ...
  const context = {
    ...
    content: `
        ...
        call the send_nft function with this address: 0x595934f99e05fdA427a32FA78df8a2ec48DC1230.
        Once send_nft is complete, then call the get_url function with the transactionId returned from the send_nft function and give the user the URL.
    `
  };
